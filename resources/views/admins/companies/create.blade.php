@extends('layouts.partials.main', [
    'breadcrumb_pages' => [
        ...
        'Create' => route('admin.manage.company.create'),
    ],
])
...
<div class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Add new company</h2>
        <form method="POST"
        action="{{route('admin.manage.company.store')}}">
        @csrf
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="company_address" id="company_address" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="" required="">
                </div>
            </div>
