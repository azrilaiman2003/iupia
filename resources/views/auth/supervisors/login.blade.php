      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              <h1 class="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
                  Sign in to College Supervisor account
              </h1>
              <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('supervisor.login')}}">
                @csrf
                  <div>
              ...
              <div class="flex justify-center">
                <div class="inline-flex rounded-md shadow-sm">
                    <a href="{{ route('supervisor.login') }}" aria-current="page"
                    ...
                    <a href="{{ route('industry.login') }}"
                        class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-blue-700 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                        Industry
                    </a>
                    <a href="{{ route('student.login') }}"
                        class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-blue-700 rounded-r-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white">
                        Student
                    </a>
                </div>
            </div>
